    ...
    <div className="bg-white dark:bg-zinc-900/50 rounded-lg border border-gray-200 dark:border-purple-500/10 overflow-hidden">
      <div className="p-5 border-b border-gray-200 dark:border-purple-500/10">
        <div className="flex items-center justify-between">
          ...
          <Link href="/games/top" className="text-gray-600 dark:text-zinc-400 hover:text-gray-900 dark:hover:text-white">
      ...
      <div className="divide-y divide-gray-200 dark:divide-purple-500/10">
        {topSellers.map((game, index) => (
          ...
          >
            <div className="w-6 text-gray-600 dark:text-zinc-500 font-bold mr-3">{index + 1}</div>
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center justify-between mt-1">
                <span className="text-gray-600 dark:text-zinc-400 text-xs">{game.sales} vendas</span>
                <span className="text-gray-900 dark:text-white font-medium text-sm">R$ {game.price.toFixed(2).replace(".", ",")}</span>
              </div>
            </div>
          </Link>
        ))}
