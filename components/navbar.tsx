    ...
    >
      ...
      <NavbarItem key="host-fivem" className="mt-0">
        <NextLink href="/fivem" className="p-0">
          <p className="p-2 m-0 bg-transparent data-[hover=true]:bg-transparent font-semibold text-sm text-gray-600 hover:text-gray-900 transition-colors duration-200 flex items-center gap-2">
