  ...
  return (
    <>
      <footer className="bg-background-dark border-t border-t-gray-800">
          ...
          <div className="grid grid-cols-2 md:grid-cols-12 gap-8 md:gap-12">
            ...
            {sections.map((section, index) => (
              <div key={`${index + 1}`} className="col-span-1 md:col-span-2">
                <h1 className="font-bold text-gray-100 mb-4">{section.title}</h1>
        ...
        {/* Adicionando o script do Tawk.to no final do footer */}
        <script
        ...
        />
        <Script
          src="https://embed.tawk.to/67e87d87770dd3190c11c213/1ini2kmam"
          strategy="afterInteractive"
          async
          crossOrigin="*"
          charSet="UTF-8"
          onLoad={() => {
            console.log("Tawk.to carregado no footer!");
          }}
        />
      </footer>
    </>
