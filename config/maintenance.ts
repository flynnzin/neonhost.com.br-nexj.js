...
export const maintenanceConfig = {
  ...
  description:
    "Nossa seção de jogos está sendo finalizada com muito carinho. Em breve você terá acesso aos melhores servidores de hospedagem para seus jogos favoritos.",
