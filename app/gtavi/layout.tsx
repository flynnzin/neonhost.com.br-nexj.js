...
export const metadata: Metadata = {
  title: {
    default: "Host GTA VI - Hospedagem Premium com Anti-DDoS | NeonHost",
    template: "%s | NeonHost",
  },
  description:
    "Crie seu servidor de GTA VI com hospedagem premium. Proteção DDoS, baixa latência em São Paulo, suporte 24/7 e compatibilidade com todas as versões.",
  keywords: [
    "NeonHost",
    "BrasilFivemHost",
    "fivemhost",
    ...
    "hospedagem GTA 6",
    "servidor GTA 6 java",
    "servidor GTA 6 bedrock",
  ],

  openGraph: {
    type: "website",
    locale: "pt_BR",
    url: "https://neonhost.com.br/GTA 6",
    title: "Servidor GTA 6 | Hospedagem Premium com Anti-DDoS | NeonHost",
