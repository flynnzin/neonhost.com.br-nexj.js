      ...
      <section className="relative z-10 max-w-full px-4 md:px-8 lg:px-12 xl:px-16 mx-auto">
        ...
        <section className="pt-[25%] md:pt-[15%] lg:pt-[10%] mb-20">
          <div className="text-center mb-12">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-indigo-100 dark:bg-indigo-900/50 border border-indigo-200 dark:border-indigo-800 text-indigo-600 dark:text-indigo-300 text-sm font-medium mb-6">
              <div className="w-2 h-2 bg-indigo-500 rounded-full mr-2"></div>
              Hospedagem Hytale em Breve
            </div>
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-3xl mx-auto">
              Estamos preparando uma solução completa de hospedagem para Hytale com alta performance, proteção avançada e suporte técnico 24/7. Em breve, você poderá criar e gerenciar seus servidores com facilidade.
            </p>
        ...
        <section className="mb-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-6 rounded-2xl bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 hover:border-indigo-300 dark:hover:border-indigo-600 transition-all duration-300 group backdrop-blur-sm">
              ...
              <h3 className="font-bold text-gray-900 dark:text-white mb-2">Proteção Anti-DDoS</h3>
            ...
            <div className="p-6 rounded-2xl bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 hover:border-indigo-300 dark:hover:border-indigo-600 transition-all duration-300 group backdrop-blur-sm">
              ...
              <h3 className="font-bold text-gray-900 dark:text-white mb-2">Baixa Latência</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm">
            ...
            <div className="p-6 rounded-2xl bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 hover:border-indigo-300 dark:hover:border-indigo-600 transition-all duration-300 group backdrop-blur-sm">
              ...
              <h3 className="font-bold text-gray-900 dark:text-white mb-2">Suporte 24/7</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm">
        ...
        <section className="py-16 mb-20">
          <div className="rounded-2xl bg-gradient-to-r from-indigo-500/20 to-blue-500/20 border border-indigo-300/30 dark:from-indigo-900/50 dark:to-blue-900/50 dark:border-indigo-700/50 p-8 md:p-16 text-center backdrop-blur-sm">
            <h2 className="text-2xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
              Hytale está chegando!
            </h2>
            <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto text-lg">
              Fique atento! Em breve você poderá gerenciar, configurar e controlar seus servidores Hytale através de nosso painel de controle intuitivo com todas as ferramentas necessárias.
            </p>
