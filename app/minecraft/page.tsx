            ...
            >
              <div className="space-y-6">
                ...
                <h1 className="text-4xl md:text-6xl font-bold leading-tight">
                  ...
                  <br />
                  <span className="text-white">de minecraft</span>
                </h1>
      ...
      <section className="relative z-10 py-20 px-4">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="flex justify-center mb-12">
            <div className="flex bg-black/50 backdrop-blur-sm rounded-xl p-1 border border-purple-500/30">
              <button
                    ...
                    <div className="space-y-4 relative z-10 p-6 pt-0">
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-gray-300">{plan.players} jogadores</span>
                        </div>
                        <div className="flex items-center gap-2">
