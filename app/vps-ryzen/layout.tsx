...
export const metadata: Metadata = {
  title: {
    default: "VPS Ryzen no Brasil com Anti DDoS - NeonHost",
    template: "%s | NeonHost",
  },
  description:
    "VPS Ryzen com processadores Ryzen 9 de alta frequência, baixa latência e proteção anti-DDoS. Ideal para servidores de Minecraft, CS:GO, ARK e mais. Ativação instantânea e painel de controle intuitivo.",
  keywords: [
    "NeonHost",
    "BrasilFivemHost",
    "fivemhost",
  ...
  openGraph: {
    type: "website",
    locale: "pt_BR",
    url: "https://neonhost.com.br/vps-ryzen",
    title: "VPS Ryzen | Servidores para Jogos | NeonHost",
