      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="pb-16" id="plans">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Nossos Planos VPS Ryzen</h2>
        ...
        <section className="pb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Tire suas dúvidas sobre nossos serviços VPS Ryzen.</p>
          </div>
          <SimpleFAQ />
        </section>
