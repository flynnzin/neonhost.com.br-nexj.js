      ...
      <section className="relative z-10 max-w-full px-4 md:px-8 lg:px-12 xl:px-16 mx-auto">
        ...
        <section className="py-20" id="plans">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 mx-auto text-lg max-w-2xl">
              Planos VPS Streaming com recursos garantidos e performance superior para seus projetos mais exigentes.
            </p>
          </div>
        ...
        <section className="mt-16 mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">Tire suas dúvidas sobre nossos serviços VPS Streaming.</p>
          </div>
          <AccordionItems />
        </section>
