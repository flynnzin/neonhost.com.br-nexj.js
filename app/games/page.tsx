...
const gameCategories = {
  ...
  upcoming: [{ id: "gta6", name: "GTA 6", status: "Em breve", image: "/games/gta6.jpg" }],
}
    ...
    <main className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <div className="container mx-auto px-4 pt-24 pb-8 relative z-10">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-4xl font-bold mb-2 relative text-gray-900 dark:text-white">
              Explore Nossos{" "}
          ...
          <div className="relative w-80">
            ...
            />
            {searchTerm && (
              <div className="absolute top-full left-0 right-0 mt-2 bg-white/95 dark:bg-gray-800/95 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-lg shadow-2xl z-20">
                <div className="p-2">
                  <div className="text-sm text-gray-600 dark:text-gray-400 mb-2">Resultados ({filteredGames.length})</div>
                  {filteredGames.slice(0, 5).map((game) => (
                    ...
                    >
                      ...
                      <div>
                        <div className="font-semibold text-sm text-gray-900 dark:text-white">{game.name}</div>
                        <div className="text-xs text-purple-600 dark:text-purple-400">R$ {game.price.toFixed(2).replace(".", ",")}</div>
                      </div>
                    </Link>
                  ))}
                </div>
        ...
        <div className="flex items-center gap-8 mb-8">
          <button
            ...
            className={`flex items-center gap-2 pb-2 transition-all duration-300 ${
              activeTab === "descobrir"
                ? "text-purple-600 dark:text-purple-400 border-b-2 border-purple-400 dark:border-purple-500"
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            {/* Featured Game */}
            <div className="relative rounded-2xl overflow-hidden mb-12 bg-gradient-to-r from-gray-100 to-gray-50 dark:from-gray-800 dark:to-gray-900 group border border-gray-200 dark:border-gray-700">
              <div className="absolute inset-0">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-r from-white/90 dark:from-gray-900/90 via-white/60 dark:via-gray-900/60 to-transparent"></div>
              </div>
              ...
              <div className="relative p-8 lg:p-12">
                <div className="max-w-2xl">
                  ...
                  <h2 className="text-5xl font-bold mb-4 text-gray-900 dark:text-white">{featuredGame.name}</h2>
                  <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 leading-relaxed">{featuredGame.description}</p>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                  {filteredGames.slice(currentGameIndex, currentGameIndex + 6).map((game) => (
                    <div key={game.id} className="group relative">
                      <div className="relative rounded-xl overflow-hidden bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-all duration-300 group-hover:scale-105 border border-gray-200 dark:border-gray-700 hover:border-purple-300 dark:hover:border-purple-600">
                            ...
                            <button
                              ...
                              className={`p-1.5 rounded-full backdrop-blur-sm transition-all duration-300 ${
                                wishlist.includes(game.id)
                                  ...
                                  : "bg-white/80 dark:bg-gray-900/80 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white"
                              }`}
                            >
                        ...
                        <div className="p-3">
                          <h3 className="font-semibold text-sm mb-1 truncate group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors text-gray-900 dark:text-white">
                            {game.name}
                          </h3>
                          <div className="flex items-center gap-1 mb-2">
                            <Star className="w-3 h-3 text-yellow-500 fill-current" />
                            <span className="text-xs text-gray-600 dark:text-gray-400">{game.rating}</span>
                            <span className="text-xs text-gray-400">•</span>
                            <span className="text-xs text-gray-600 dark:text-gray-400">{game.players}</span>
                          </div>
                          <div className="flex items-center gap-2">
                            {game.originalPrice && (
            ...
            <section className="mb-12">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Notícias & Guias</h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {newsGuides.map((item) => (
                  ...
                  >
                    ...
                    <div className="p-4">
                      <div className="text-purple-600 dark:text-purple-400 text-sm font-semibold mb-2">{item.category}</div>
                      <h3 className="font-bold mb-2 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors text-gray-900 dark:text-white">
                        {item.title}
                      </h3>
            ...
            {/* Game Categories */}
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Categorias de Jogos</h2>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Best Sellers */}
                <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-6 border border-gray-200 dark:border-gray-700 hover:border-purple-300 dark:hover:border-purple-600 transition-colors group">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-bold group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors text-gray-900 dark:text-white">
                      Mais Vendidos
                    </h3>
                    ...
                    {gameCategories.bestsellers.map((game, index) => (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <h4 className="font-semibold group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors text-gray-900 dark:text-white">
                            {game.name}
                          </h4>
                          <p className="text-purple-600 dark:text-purple-400 font-bold">R$ {game.price.toFixed(2).replace(".", ",")}</p>
                        </div>
                  ...
                  <Link href="/games/category/bestsellers">
                    <button className="w-full mt-4 border border-purple-300 dark:border-purple-700 text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/50 bg-transparent py-2 px-4 rounded-lg font-semibold transition-all duration-300">
                      Ver todos
                    </button>
                  </Link>
                </div>
                  ...
                  <div className="space-y-3">
                    {gameCategories.upcoming.map((game) => (
                      <div key={game.id} className="flex items-center gap-3 p-2 rounded-lg">
                        ...
                        <div className="flex-1">
                          <h4 className="font-semibold text-gray-900 dark:text-white">{game.name}</h4>
                          <p className="text-orange-500 font-semibold text-sm">{game.status}</p>
                        </div>
            ...
            {/* New Games */}
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Jogos Novos</h2>

              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="relative rounded-xl overflow-hidden bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 group border border-gray-200 dark:border-gray-700">
                  <div className="absolute inset-0">
                    <Image
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-r from-white/80 dark:from-gray-900/80 to-transparent"></div>
                  </div>
                  ...
                  <div className="relative p-6">
                    ...
                    <h3 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">Palworld</h3>
                    <div className="flex items-center gap-2 mb-4">
                      <span className="text-gray-500 dark:text-gray-400 line-through">R$ 120,00</span>
                      <span className="text-2xl font-bold text-gray-900 dark:text-white">R$ 79,90</span>
                ...
                <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                  <h3 className="text-lg font-bold mb-4 text-gray-900 dark:text-white">Por que jogar os novos lançamentos?</h3>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold mb-1 text-gray-900 dark:text-white">Experiência Inovadora</h4>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold mb-1 text-gray-900 dark:text-white">Comunidade Ativa</h4>
                        <p className="text-gray-600 dark:text-gray-400 text-sm">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold mb-1 text-gray-900 dark:text-white">Ofertas Exclusivas</h4>
                        <p className="text-gray-600 dark:text-gray-400 text-sm">
            ...
            <section className="mb-12">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Jogos com Descontos</h2>
              </div>

              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                {getDiscountedGames().map((game) => (
                  <div key={game.id} className="group relative">
                    <div className="relative rounded-xl overflow-hidden bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-all duration-300 group-hover:scale-105 border border-gray-200 dark:border-gray-700 hover:border-orange-300 dark:hover:border-orange-600">
                      <div className="aspect-[4/3] relative">
                        <Image src={game.image || "/placeholder.svg"} alt={game.name} fill className="object-cover" />
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-orange-100/20 dark:from-orange-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                      </div>
                      <div className="p-3">
                        <h3 className="font-semibold text-sm mb-1 truncate group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors text-gray-900 dark:text-white">
                          {game.name}
                        </h3>
                        <div className="flex items-center gap-2">
                          <span className="text-gray-400 dark:text-gray-500 line-through text-xs">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
              {/* Games in Highlight */}
              <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-6 border border-gray-200 dark:border-gray-700 backdrop-blur-sm">
                  ...
                  {gamesInHighlight.map((game) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="font-semibold truncate group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors text-gray-900 dark:text-white">
                          {game.name}
                        </h4>
              ...
              {/* Quick Actions */}
              <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-6 border border-gray-200 dark:border-gray-700 backdrop-blur-sm">
                <h3 className="text-lg font-bold mb-4 text-gray-900 dark:text-white">Ações Rápidas</h3>
                <div className="space-y-3">
                  <button
              ...
              {/* Newsletter */}
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl p-6 border border-purple-200 dark:border-purple-800 backdrop-blur-sm">
                <h3 className="text-lg font-bold mb-2 text-gray-900 dark:text-white">🔥 Ofertas Exclusivas</h3>
                <p className="text-sm text-gray-700 dark:text-gray-300 mb-4">Receba descontos especiais e novidades em primeira mão!</p>
                <div className="space-y-3">
                  <input
                    type="email"
