    ...
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <div className="container mx-auto px-4 pt-24 pb-8 relative z-10">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-4xl font-bold mb-2 relative text-gray-900">
              Explore Nossos{" "}
          ...
          <div className="relative w-80">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-500 focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-500/20 backdrop-blur-sm transition-all duration-300"
            />
            {searchTerm && (
              <div className="absolute top-full left-0 right-0 mt-2 bg-white/95 backdrop-blur-sm border border-gray-200 rounded-lg shadow-2xl z-20">
                <div className="p-2">
                  <div className="text-sm text-gray-600 mb-2">Resultados ({filteredGames.length})</div>
                  {filteredGames.slice(0, 5).map((game) => (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-xs text-purple-600">R$ {game.price.toFixed(2).replace(".", ",")}</div>
                      </div>
                    </Link>
                  ))}
                </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            {/* Featured Game */}
            <div className="relative rounded-2xl overflow-hidden mb-12 bg-gradient-to-r from-gray-100 to-gray-50 group border border-gray-200">
              ...
              <div className="relative p-8 lg:p-12">
                <div className="max-w-2xl">
                  ...
                  <h2 className="text-5xl font-bold mb-4 text-gray-900">{featuredGame.name}</h2>
                  <p className="text-gray-700 text-lg mb-6 leading-relaxed">{featuredGame.description}</p>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                  {filteredGames.slice(currentGameIndex, currentGameIndex + 6).map((game) => (
                    <div key={game.id} className="group relative">
                      <div className="relative rounded-xl overflow-hidden bg-gray-50 hover:bg-gray-100 transition-all duration-300 group-hover:scale-105 border border-gray-200 hover:border-purple-300">
                        ...
                        <div className="p-3">
                          <h3 className="font-semibold text-sm mb-1 truncate group-hover:text-purple-600 transition-colors text-gray-900">
                            {game.name}
                          </h3>
                          <div className="flex items-center gap-1 mb-2">
                            ...
                            <span className="text-xs text-gray-600">{game.players}</span>
                          </div>
                          <div className="flex items-center gap-2">
                            {game.originalPrice && (
            ...
            <section className="mb-12">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-gray-900">Notícias & Guias</h2>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {newsGuides.map((item) => (
                  <div
                    key={item.id}
                    className="bg-gray-50 rounded-xl overflow-hidden hover:bg-gray-100 transition-all duration-300 group-hover:scale-105 border border-gray-200 hover:border-purple-300"
                  >
                    ...
                    <div className="p-4">
                      <div className="text-purple-600 text-sm font-semibold mb-2">{item.category}</div>
                      <h3 className="font-bold mb-2 group-hover:text-purple-600 transition-colors text-gray-900">
                        {item.title}
                      </h3>
            ...
            {/* Game Categories */}
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-gray-900">Categorias de Jogos</h2>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {/* Best Sellers */}
                <div className="bg-gray-50 rounded-xl p-6 border border-gray-200 hover:border-purple-300 transition-colors group">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-bold group-hover:text-purple-600 transition-colors text-gray-900">
                      Mais Vendidos
                    </h3>
                    ...
                    {gameCategories.bestsellers.map((game, index) => (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <h4 className="font-semibold group-hover:text-purple-600 transition-colors text-gray-900">
                            {game.name}
                          </h4>
                          <p className="text-purple-600 font-bold">R$ {game.price.toFixed(2).replace(".", ",")}</p>
                        </div>
                  ...
                  <Link href="/games/category/bestsellers">
                    <button className="w-full mt-4 border border-purple-300 text-purple-600 hover:bg-purple-50 bg-transparent py-2 px-4 rounded-lg font-semibold transition-all duration-300">
                      Ver todos
                    </button>
                  </Link>
                </div>
            ...
            {/* New Games */}
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-gray-900">Jogos Novos</h2>

              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="relative rounded-xl overflow-hidden bg-gradient-to-r from-blue-50 to-purple-50 group border border-gray-200">
                  <div className="absolute inset-0">
                    <Image
                  ...
                  <div className="relative p-6">
                    ...
                    <h3 className="text-2xl font-bold mb-2 text-gray-900">Palworld</h3>
                ...
                <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                  <h3 className="text-lg font-bold mb-4 text-gray-900">Por que jogar os novos lançamentos?</h3>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold mb-1 text-gray-900">Experiência Inovadora</h4>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold mb-1 text-gray-900">Comunidade Ativa</h4>
                        <p className="text-gray-600 text-sm">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold mb-1 text-gray-900">Ofertas Exclusivas</h4>
                        <p className="text-gray-600 text-sm">
            ...
            <section className="mb-12">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-gray-900">Jogos com Descontos</h2>
              </div>

              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                {getDiscountedGames().map((game) => (
                  <div key={game.id} className="group relative">
                    <div className="relative rounded-xl overflow-hidden bg-gray-50 hover:bg-gray-100 transition-all duration-300 group-hover:scale-105 border border-gray-200 hover:border-orange-300">
                      <div className="aspect-[4/3] relative">
                        <Image src={game.image || "/placeholder.svg"} alt={game.name} fill className="object-cover" />
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-orange-100/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                      </div>
                      <div className="p-3">
                        <h3 className="font-semibold text-sm mb-1 truncate group-hover:text-orange-600 transition-colors text-gray-900">
                          {game.name}
                        </h3>
                        <div className="flex items-center gap-2">
                          <span className="text-gray-400 line-through text-xs">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-6">
                  ...
                  {gamesInHighlight.map((game) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="font-semibold truncate group-hover:text-purple-600 transition-colors text-gray-900">
                          {game.name}
                        </h4>
              ...
              {/* Quick Actions */}
              <div className="bg-gray-50 rounded-xl p-6 border border-gray-200 backdrop-blur-sm">
                <h3 className="text-lg font-bold mb-4 text-gray-900">Ações Rápidas</h3>
                <div className="space-y-3">
                  <button
                  ...
                  <button
                    ...
                    className="w-full border border-purple-300 text-purple-600 hover:bg-purple-50 bg-transparent py-2 px-4 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="w-full border border-gray-300 text-gray-600 hover:bg-gray-100 bg-transparent py-2 px-4 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center gap-2"
                  >
              ...
              {/* Newsletter */}
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-200 backdrop-blur-sm">
                <h3 className="text-lg font-bold mb-2 text-gray-900">🔥 Ofertas Exclusivas</h3>
                <p className="text-sm text-gray-700 mb-4">Receba descontos especiais e novidades em primeira mão!</p>
                <div className="space-y-3">
                  <input
                    type="email"
                    placeholder="Seu melhor e-mail"
                    className="w-full px-3 py-2 bg-white border border-gray-200 rounded-lg text-gray-900 placeholder-gray-500 focus:border-purple-500 focus:outline-none text-sm"
                  />
